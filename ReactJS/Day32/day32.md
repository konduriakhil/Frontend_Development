...
## If we hit refresh button the items in the cart are vanishing now our goal is to store those products in the cart even hit refresh

- We are copying the products data and calling this data from local machine **public/products.json**
- Now internet is not necessary when ever we use this produts page
...
- After refresh also items are not erasing.
  ![alt text](images/img3.png)

## remove form the cart task
...
export const { addToCart, removeFromCart, decrementCartItems } =
  cartSlice.actions;
...
export const { addToCart, removeFromCart, decrementCartItems, clearCart } =
  cartSlice.actions;

export default cartSlice.reducer;
```

## Cart Total Amount and Cart Total Quantity
      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link to="/postst" className="nav-link">
                PostsTemporary
              </Link>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <Link to="/carttemp" className="nav-link">
                CartTemporary
              </Link>
            </li>
          </ul>
...
## After Proceed to Checkout empty the cart and display payment is done
 ```jsx
import React from 'react'
import Header from './Header'
import Footer from './Footer'
